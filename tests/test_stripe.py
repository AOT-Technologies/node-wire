...
async def test_stripe_charge_happy_path():
    ...
    mock_charge = {"id": "ch_123", "receipt_url": "http://stripe.com/receipt", "paid": True}
...
async def test_stripe_create_payment_intent_happy_path():
    ...
    mock_pi = {"id": "pi_123", "client_secret": "secret_abc", "status": "requires_payment_method"}
...
async def test_stripe_create_subscription_with_card_token():
    ...
    mock_sub = {"id": "sub_123", "status": "active"}
...
async def test_stripe_cancel_subscription_immediate():
    ...
    mock_sub = {"id": "sub_123", "status": "canceled"}
    ...
    mock_cancel.assert_called_once_with("sub_123", api_key="sk_test_mock")
...
async def test_stripe_issue_refund_happy_path():
    ...
    mock_refund = {"id": "re_123", "status": "succeeded"}
